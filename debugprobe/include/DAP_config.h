...
__STATIC_INLINE void PORT_SWD_SETUP (uint32_t probeId) {
  probe_init(probeId);
  cached_delay = 0;
}
...
*/
__STATIC_INLINE void PORT_OFF (uint32_t probeId) {
  probe_deinit(probeId);
}
...
*/
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT_ENABLE  (uint32_t probeId) {
  probe_write_mode(probeId);
}
...
*/
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT_DISABLE (uint32_t probeId) {
...
/*__STATIC_INLINE void DAP_SETUP (uint32_t probeId) {
...
*/
__STATIC_INLINE uint8_t RESET_TARGET (uint32_t probeId) {
