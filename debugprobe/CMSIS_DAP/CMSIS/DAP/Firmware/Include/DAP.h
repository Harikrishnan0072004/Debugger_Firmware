...
extern          DAP_Data_t DAP_Data[PROBE_DAP_COUNT];            // DAP Data
extern volatile uint8_t    DAP_TransferAbort[PROBE_DAP_COUNT];   // Transfer Abort Flag
...
// Functions
extern void     SWJ_Sequence    (uint32_t probeId, uint32_t count, const uint8_t *data);
extern void     SWD_Sequence    (uint32_t probeId, uint32_t info,  const uint8_t *swdo, uint8_t *swdi);
extern void     JTAG_Sequence   (uint32_t probeId, uint32_t info,  const uint8_t *tdi,  uint8_t *tdo);
extern void     JTAG_IR         (uint32_t probeId, uint32_t ir);
extern uint32_t JTAG_ReadIDCode (uint32_t probeId);
extern void     JTAG_WriteAbort (uint32_t probeId, uint32_t data);
extern uint8_t  JTAG_Transfer   (uint32_t probeId, uint32_t request, uint32_t *data);
extern uint8_t  SWD_Transfer    (uint32_t probeId, uint32_t request, uint32_t *data);

extern void     Delayms         (uint32_t probeId, uint32_t delay);
...
extern uint32_t DAP_ProcessVendorCommand (uint32_t probeId, const uint8_t *request, uint8_t *response);
extern uint32_t DAP_ProcessCommand       (uint32_t probeId, const uint8_t *request, uint8_t *response);
extern uint32_t DAP_ExecuteCommand       (uint32_t probeId, const uint8_t *request, uint8_t *response);

extern void     DAP_Setup (uint32_t probeId);
